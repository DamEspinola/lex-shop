...
export const initialData: SeedData = {
  ...
  category: ["shirts", "pants", "hoodies", "hats", "smartphone", "notebook", "fragrance"],
  products: [
    {
      description:
