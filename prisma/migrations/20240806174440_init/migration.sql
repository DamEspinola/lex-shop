...
-- CreateEnum
CREATE TYPE "Colors" AS ENUM ('BLACK', 'WHITE', 'BLUE', 'PINK', 'RED', 'DEEP_BLUE', 'SPACE_GRAY', 'SILVER');

-- CreateEnum
CREATE TYPE "Categories" AS ENUM ('fashion_men', 'fashion_women', 'fashion_kid', 'fashion_unisex', 'accessories', 'fragances', 'appliances', 'informatics', 'smartphones');
